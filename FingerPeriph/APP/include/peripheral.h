 ...
 * Version            : V1.0
 * Date               : 2018/12/11
 * Description        : 手指 Peripheral（单链路）：勿用手机占 ACL；Char4 NOTIFY 依赖手腕 Central 写 CCCD
 *********************************************************************************
...
/*
 * Peripheral_FingerNotifyJson - 把当前 HR/SpO2 拼装为 JSON 通过 Char4 Notify 发送
 ...
 */
extern void Peripheral_FingerNotifyJson(uint8_t hr, uint8_t spo2, uint16_t beat_idx,
