...
// Char4 = JSON 串 `{"id":N,"ts":T,"hr":H,"spo2":S}`，最坏 ~44 字节，取 50 字节有余量
// Notify 实际可用 = 当前 MTU - 3，依赖 ESP32-C3 端 setMTU(64) 后协商出 ~61 字节
#define SIMPLEPROFILE_CHAR1_LEN     1
#define SIMPLEPROFILE_CHAR2_LEN     1
#define SIMPLEPROFILE_CHAR3_LEN     1
#define SIMPLEPROFILE_CHAR4_LEN     120  /* Peripheral Notify JSON max length (含 wf) */
